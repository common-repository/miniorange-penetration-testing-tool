<!-- The Modal -->
    <div id="wpns_feedback_modal" class="mo_modal" style="width:90%; margin-left:12%; margin-top:5%; text-align:center; margin-left;">
        ...
        <div class="mo_wpns_modal-content" style="width:50%;">
            ...
            <form name="f" method="post" action="" id="mospt_feedback">
                <?php wp_nonce_field("mospt_feedback");?>
                <input type="hidden" name="option" value="mospt_feedback"/>
					...
					<div style="text-align:center;">
						...
						<br><br>
						<textarea id="mospt_query_feedback" name="mospt_query_feedback" rows="4" style="width: 60%"
                    ...
                    <div class="mo-modal-footer" style="text-align: center;margin-bottom: 2%">
                        <input type="submit" name="mospt_feedback_submit"
                               style="background-color:#20b2aa; padding: 1% 3% 1% 3%;color: white;cursor: pointer;" value="Send"/>
						<span width="30%">&nbsp;&nbsp;</span>
                        <input type="button" name="mospt_skip_feedback"
                               style="background-color:#20b2aa; padding: 1% 3% 1% 3%;color: white;cursor: pointer;" value="Skip" onclick="document.getElementById('mospt_feedback_form_close').submit();"/>
                    </div>
                </div>
            ...
            <form name="f" method="post" action="" id="mospt_feedback_form_close">
                <?php wp_nonce_field("mospt_skip_feedback");?>
                <input type="hidden" name="option" value="mospt_skip_feedback"/>
            </form>
    ...
    <script>
        jQuery('a[aria-label="Deactivate miniOrange Penetration Testing Tool"]').click(function () {
...
// When the user clicks the button, open the mo2f_modal
			...
			document.querySelector("#mospt_query_feedback").focus();
