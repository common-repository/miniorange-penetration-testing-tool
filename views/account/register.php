...
$nonce = wp_create_nonce('mospt-register-nonce');
echo'<!--Register with miniOrange-->
	<form name="f" method="post" action="">
		<input type="hidden" name="option" value="mo_wpns_register_customer" />
		<input type="hidden" name="mospt_register_nonce" value="'.$nonce.'" />
		<div class="mo_wpns_divided_layout">
		<div class="mo_wpns_setting_layout" style="margin-bottom:30px;">
			
				<h3>Register with miniOrange</h3>
				<p>Just complete the short registration below to configure miniOrange Site PenTest Plugin. Please enter a valid email id that you have access to.</p>
				<table class="mo_wpns_settings_table">
					...
					<tr>
						<td>&nbsp;</td>
						<td colspan="2"><input type="submit" name="submit" value="Register" style="width:100px;"
							class="mo_wpns_button mo_wpns_button1" />
                        <a class="mo_wpns_button mo_wpns_button1" href="#mo2f_account_exist">Already have an Account? Sign In</a></td>
					</tr>
				</table>
		</div>	
		</div>
