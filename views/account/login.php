<?php		
$login_nonce = wp_create_nonce('mospt-login-nonce');
$cancel_nonce =wp_create_nonce('mospt-cancel-nonce');

echo'	<form name="f" method="post" action="">
			<input type="hidden" name="option" value="mo_wpns_verify_customer" />
			<input type="hidden" name="mospt_login_nonce" value="'.$login_nonce.'" />
		...
		<form id="cancel_form" method="post" action="">
			...
			<input type="hidden" name="mospt_cancel_nonce" value="'.$cancel_nonce.'" />
